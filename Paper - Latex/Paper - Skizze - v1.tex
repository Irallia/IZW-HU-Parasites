    ...
    \subsection{Countings}
      ...
      \begin{center}
        \begin{tabular}{ | l | p{3cm} | }
          ...
          freeliving species & 48875 (distinct) \\ \hline
          parasite species &  64125 (distinct) \\ \hline
          unused possible species & 2126 (source), 2144439 (target) \\
          % number of freelivings: 509595
          % number of freelivings: 45881 (distinct)
          % number of parasites: 3438001
          % number of parasites: 63532 (distinct)
          % number of SAME_AS: 16012
          % number of SAME_AS: 5667 (distinct)
          \hline  
        \end{tabular}
      \end{center}
