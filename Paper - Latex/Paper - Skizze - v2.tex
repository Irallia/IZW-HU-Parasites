      ...
      \subsubsection{Poisson regression}
        ...
        \begin{center}
          \begin{tabular}{ |l|r|l| }
            ...
            % 1] "-------------------phylum - depth / min/max/mean.height-----------------------"
            % Analysis of Deviance Table

            % Model 1: multifurc ~ phylum
            % Model 2: multifurc ~ phylum + depth
            % Model 3: multifurc ~ phylum + min.height
            % Model 4: multifurc ~ phylum + max.height
            % Model 5: multifurc ~ phylum + mean.height
            %   Resid. Df Resid. Dev Df Deviance  Pr(>Chi)
            % 1    167173    7435700
            % 2    167172    7431609  1     4090 < 2.2e-16 ***
            % 3    167172    7233486  0   198124
            % 4    167172    7375889  0  -142403
            % 5    167172    7128318  0   247570
            % ---
            % Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
            % [1] "--------------------------------------------------"
