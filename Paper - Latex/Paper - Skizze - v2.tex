...
\begin{document}
  ...
  \begin{titlepage}
    \pagestyle{empty}
    	...
    	\vspace{20mm}
    	\begin{Large}
    	    \textbf{An analysis of the Castor package to predict parasitism in Eukaryota}\\
      \end{Large}
...
\chapter{Methods}
  ...
  \section{Get data - Properties of real Data}
    ...
    \subsection{OTL}
      ...
      Taxonomic Information System), NCBI (National Center for Biotechnology Information [18]), WORMS 
      (World Register of Marine Species [14]), GBIF (Global Biodiversity Information Facility [17]), 
      OTT (OpenTreeOfLife-Taxonomy [4]).
      ...
      We choosed the taxonomy from OpenTreeOfLife because it's including most of the known taxonomies 
        ...
        same time the team from OTL preferred a maximum number of species [4]. This is resulting in 
        somekind of hybrid between taxonomy and phylogeny." \\
    ...
    \todotext{Marius:} "There aren't many big active interaction databases out there, most of them are 
      offline or outdated. For example: Interaction Web Database [35], Webs on the Web [36], Animal 
      Diversity Web [37] and ecoweb [38]. GloBI is including most of the known ones and is still growing 
      actively [3]. So the question which interaction database could be used was answered rather quickly." \\ \\
  ...
  \section{Metadata analysis}
    ...
    \subsection{Multifurcation}
      ...
      \todotext{Subfigure \ref{fig:childrenOfNodes_innerNodes} beschränkt sich hierbei nur auf die inner 
        nodes während Subfigure \ref{fig:childrenOfNodes_allNodes} alle Knoten abbildet.} \\
      ...
      \end{figure}
      As you can see, we are very far from a binary tree. Therefore, the impact of multifurcations on 
...
\chapter{Results}
  ...
  \section{Metadata analysis}
    ...
    \subsection{Taxa}
      ...
      \todo{Hier fehlt nichts. Ref einfügen.} \\
      Phyla (53): \\
