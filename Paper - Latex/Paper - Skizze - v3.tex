...
\chapter{Methods}
  ...
  \section{Metadata analysis}
    ...
    \subsection{Transition probabilities}
      ...
      In general, we assume that there are 40\% parasites and 60\% free-livings \todo{ref} and 
    ...
    \subsection{Multifurcation}
      ...
      \todo{Einfluss auf die Vorhersage des Castor und Fitch Algorithmus (Simulation)}
  ...
  \section{Simulation}\label{sec:simulation}
    ...
    \subsection{simulating loss of information of the tree topology}
      As previously explained, some divisions in the tree are not known, so the real tree is not binary.
        We simulate this multifurcation of the tree by \todo{...}.
      
      On the one hand, the strength of multifunctionation plays a role, as does the distribution. 
        Modeling was done as explained in \todo{sec x}.
      
      \todo{bisher ohne Begründung:!!!}
      we decided to use a $\frac{1}{x}$ distribution, where x is the depth of a node. This means, how 
      deaper we are, how less information we have. \\
    ...
    %---------------------------------------------------------------------------------------------------
    %---------------------------------------------------------------------------------------------------
    \section{maximum parsimony algorithms}
...
   
  ...
  \section{Unknown leaf nodes}
    ...
    We also compared different models in terms of their BICs (Table: \ref{table:BIC unknown information}). 
      ...
      % Model 1: globi.data ~ kingdom + depth
      % Model 2: globi.data ~ kingdom * depth
      %   Resid. Df Resid. Dev Df Deviance  Pr(>Chi)
      % 1   2297502     544789
      % 2   2297499     544062  3   727.05 < 2.2e-16 ***

      % Model 1: globi.data ~ phylum + depth
      % Model 2: globi.data ~ phylum * depth
      % Resid. Df Resid. Dev Df Deviance  Pr(>Chi)
      % 1   2297453     493017
      % 2   2297406     488366 47   4650.8 < 2.2e-16 ***
...
\newpage
  ...
  \section{Effects of Taxa in the different models}
    ...
    \anmerkung{different parameters for different taxa? (Emanuel) -> Effects...} \\ \\
    ...
    \begin{table}[h!]
      \begin{center}
        \begin{longtable}{ |l|l|r|r|r| }
          ...
          & ... & ... & ... & ... \\
          % & Priapulida          & 4.347826e-02 & 8.773029e-02 \\
          % & Tardigrada          & 1.736770e-07 & 3.393298e-07 \\
          % & Chordata            & 1.140600e-01 & 8.242171e-02 \\
          % & Xanthophyceae       & 1.736770e-07 & 3.483928e-07 \\
          % & Haptophyta          & 3.484321e-03 \\
          % & Microsporidia       & 8.703271e-02 \\
          % & Chytridiomycota     & 3.062361e-02 \\
          % & Nematomorpha        & 1.495017e-02 \\
          % & Loricifera          & 1.736770e-07 \\
          % & Gnathostomulida     & 1.736770e-07 \\
          % & Myzostomida         & 4.464286e-03 \\
          % & Gastrotricha & 1.736770e-07 \\
          % & Ciliophora & 8.372371e-03 \\
          % & Entoprocta & 1.736770e-07 \\
          % & Glomeromycota & 6.609385e-04 \\
          % & Nematoda & 1.098682e-01 \\
          % & Cycliophora & 1.736770e-07 \\
          % & Apicomplexa & 1.374128e-01 \\
          % & Ascomycota & 1.232671e-02 \\
          % & Bryozoa & 4.194290e-03 \\
          % & Nemertea & 9.465855e-03 \\
          % & Echinodermata & 1.971448e-02 \\
          % & Rotifera & 8.638563e-03 \\
          % & Picozoa & 1.736770e-07 \\
          % & Phaeophyceae & 1.219884e-03 \\
          % & Acanthocephala & 3.935018e-01 \\
          % & Bacillariophyta & 4.757374e-05 \\
          % & Colponemidia & 1.736770e-07 \\
          % & Platyhelminthes & 3.127011e-01 \\
          % & Entorrhizomycota & 1.736770e-07 \\
          % & Chaetognatha & 2.941176e-02 \\
          % & Placozoa & 1.736770e-07 \\
          % & Euglenida & 1.729107e-03 \\
          % & Arthropoda & 2.506545e-02 \\
          % & Basidiomycota & 6.149777e-03 \\
          % & Cnidaria & 1.928587e-02 \\
          % & Ctenophora & 4.205607e-02 \\
          % & Kinorhyncha & 1.736770e-07 \\
          % & Porifera & 7.720212e-03 \\
          % & Orthonectida & 1.153846e-01 \\
          % & Mollusca & 9.876095e-03 \\
          % & Brachiopoda & 6.920415e-03 \\
          % & Haplosporida & 8.108108e-02 \\
          % & Rhodophyta & 1.971220e-04 \\
          % & Streptophyta & 8.901842e-03 \\
          % & Foraminifera & 3.395201e-04 \\
          % & Chlorophyta & 3.084992e-04 \\
          \hline \hline
          ...
          & Metazoa             & 0.005414443 & ... & ... \\
          % \hline
          % Phylum & no phylum    & XXXXX & 3.001749e-02 & 5.757839e-03 \\
          % & Rhombozoa           & XXXXX & 4.128162e-02 & 1.000000e+00 \\
          % & Hemichordata        & XXXXX & 3.791496e-07 & 1.736742e-07 \\
          % & Chromerida          & XXXXX & 4.605436e-07 & 2.220446e-16 \\
          % & Amoebozoa           & XXXXX & 1.312565e-02 & 2.401619e-03 \\
          % & Onychophora         & XXXXX & 3.663718e-07 & 1.736753e-07 \\
          % & ... & ... & ... & ... \\
          \hline
        \end{longtable} 
      \end{center}
...
%        ['ott151014', 'Haptophyta']      ['ott16113', 'Microsporidia']
%                       1.023682e-02                       2.297956e-01
%   ['ott177160', 'Chytridiomycota']      ['ott189836', 'Nematomorpha']
%                       8.586035e-02                       3.000311e-02
%        ['ott199402', 'Loricifera']   ['ott242963', 'Gnathostomulida']
%                       3.538708e-07                       3.160858e-07
%       ['ott260040', 'Myzostomida']       ['ott29723', 'Gastrotricha']
%                       9.396517e-03                       3.335103e-07
%        ['ott302424', 'Ciliophora']        ['ott362916', 'Entoprocta']
%                       2.114329e-02                       3.281554e-07
%     ['ott385878', 'Glomeromycota']          ['ott395057', 'Nematoda']
%                       1.687966e-03                       1.582959e-01
%        ['ott41147', 'Cycliophora']       ['ott422673', 'Apicomplexa']
%                       3.160858e-07                       2.849943e-01
%        ['ott439373', 'Ascomycota']           ['ott442934', 'Bryozoa']
%                       2.217673e-02                       7.020371e-03
%          ['ott445195', 'Nemertea']     ['ott451020', 'Echinodermata']
%                       1.640797e-02                       3.399753e-02
%          ['ott471706', 'Rotifera']          ['ott4738955', 'Picozoa']
%                       1.516272e-02                       6.032169e-07
%       ['ott48614', 'Phaeophyceae']     ['ott49622', 'Acanthocephala']
%                       2.014280e-03                       5.672835e-01
%  ['ott5342311', 'Bacillariophyta']     ['ott5355158', 'Colponemidia']
%                       1.048765e-04                       5.155971e-07
%   ['ott555379', 'Platyhelminthes'] ['ott5653719', 'Entorrhizomycota']
%                       4.271198e-01                       4.449469e-07
%      ['ott570366', 'Chaetognatha']          ['ott570376', 'Placozoa']
%                       5.936368e-02                       4.965510e-07
%        ['ott6137051', 'Euglenida']        ['ott632179', 'Arthropoda']
%                       4.727403e-03                       1.935197e-02
%     ['ott634628', 'Basidiomycota']          ['ott641033', 'Cnidaria']
%                       1.149917e-02                       3.192464e-02
%        ['ott641212', 'Ctenophora']       ['ott677389', 'Kinorhyncha']
%                       1.077673e-01                       3.540771e-07
%           ['ott67819', 'Porifera']      ['ott691845', 'Orthonectida']
%                       1.613863e-02                       2.716252e-01
%          ['ott802117', 'Mollusca']       ['ott826261', 'Brachiopoda']
%                       1.372700e-02                       1.079344e-02
%      ['ott858063', 'Haplosporida']        ['ott878953', 'Rhodophyta']
%                       1.925711e-01                       5.358571e-04
%      ['ott916750', 'Streptophyta']      ['ott936399', 'Foraminifera']
%                       6.529378e-03                       7.447417e-04
%       ['ott979501', 'Chlorophyta']
%                       7.296356e-04

% ['ott1085175', 'Priapulida']        ['ott111438', 'Tardigrada']
%                       1.000000e+00                       1.736778e-07
%          ['ott125642', 'Chordata']     ['ott151001', 'Xanthophyceae']
%                       1.138205e-01                       1.736786e-07
%        ['ott151014', 'Haptophyta']      ['ott16113', 'Microsporidia']
%                       1.000000e+00                       9.998257e-01
%   ['ott177160', 'Chytridiomycota']      ['ott189836', 'Nematomorpha']
%                       1.000000e+00                       2.220446e-16
%        ['ott199402', 'Loricifera']   ['ott242963', 'Gnathostomulida']
%                       2.220446e-16                       2.220446e-16
%       ['ott260040', 'Myzostomida']       ['ott29723', 'Gastrotricha']
%                       4.381889e-06                       1.736782e-07
%        ['ott302424', 'Ciliophora']        ['ott362916', 'Entoprocta']
%                       5.518629e-05                       1.736802e-07
%     ['ott385878', 'Glomeromycota']          ['ott395057', 'Nematoda']
%                       9.966669e-01                       4.725574e-01
%        ['ott41147', 'Cycliophora']       ['ott422673', 'Apicomplexa']
%                       2.220446e-16                       8.049756e-01
%        ['ott439373', 'Ascomycota']           ['ott442934', 'Bryozoa']
%                       1.541511e-02                       1.230174e-03
%          ['ott445195', 'Nemertea']     ['ott451020', 'Echinodermata']
%                       1.777755e-01                       2.505179e-03
%          ['ott471706', 'Rotifera']          ['ott4738955', 'Picozoa']
%                       3.125183e-01                       1.736782e-07
%       ['ott48614', 'Phaeophyceae']     ['ott49622', 'Acanthocephala']
%                       9.252076e-04                       3.992551e-04
%  ['ott5342311', 'Bacillariophyta']     ['ott5355158', 'Colponemidia']
%                       1.114784e-10                       2.220446e-16
%   ['ott555379', 'Platyhelminthes'] ['ott5653719', 'Entorrhizomycota']
%                       2.478056e-02                       1.736781e-07
%      ['ott570366', 'Chaetognatha']          ['ott570376', 'Placozoa']
%                       1.000000e+00                       4.021433e-08
%        ['ott6137051', 'Euglenida']        ['ott632179', 'Arthropoda']
%                       9.257999e-01                       1.658528e-02
%     ['ott634628', 'Basidiomycota']          ['ott641033', 'Cnidaria']
%                       1.473459e-03                       1.218008e-02
%        ['ott641212', 'Ctenophora']       ['ott677389', 'Kinorhyncha']
%                       2.878555e-03                       1.736844e-07
%           ['ott67819', 'Porifera']      ['ott691845', 'Orthonectida']
%                       1.329787e-02                       2.931611e-02
%          ['ott802117', 'Mollusca']       ['ott826261', 'Brachiopoda']
%                       5.167513e-03                       9.974617e-01
%      ['ott858063', 'Haplosporida']        ['ott878953', 'Rhodophyta']
%                       9.999999e-01                       9.658119e-11
%      ['ott916750', 'Streptophyta']      ['ott936399', 'Foraminifera']
%                       6.037565e-03                       6.367782e-03
%       ['ott979501', 'Chlorophyta']
%                       2.027010e-05
...
%---------------------------------------------------------------------------------------------------
%---------------------------------------------------------------------------------------------------
\chapter{Komplett aussortierte Tabellen etc}
