      ...
      \begin{table}[h!]
        \begin{center}
          \begin{tabular}{ |l|r|r|r| }
            ...
            \hline
            multifurc $\sim$ taxa + depth & 544789 & 493017 & XXXXX \\
            \hline
            multifurc $\sim$ taxa * depth & 544062 & 488366 & \cellcolor{green!60}XXXXX \\
            \hline
          \end{tabular} 
        \end{center}
      ...
      \begin{table}[h!]
        \begin{center}
          \begin{tabular}{ |l|r|r|r| }
            ...
            Model / Taxa & Kingdom & Phylum & Class \\
            \hline \hline
            multifurc $\sim$ taxa & \cellcolor{green!15}545799 & \cellcolor{green!35}500004 & \cellcolor{green!45}485121 \\
            \hline
            multifurc $\sim$ taxa + depth & \cellcolor{green!15}544862 & \cellcolor{green!40}493808 & \cellcolor{green!45}481869 \\
            \hline
            multifurc $\sim$ taxa * depth & \cellcolor{green!15}544179 & \cellcolor{green!45}489845 & \cellcolor{green!50}XXXXX \\
            \hline
          \end{tabular} 
        \end{center}
    ...
    \begin{table}[h!]
      \begin{center}
        \begin{tabular}{ |l|l|r|r|r|r| }
          ...
          % \hline
          % Class & globi $\sim$ taxa & 0,10 & 628190,10 & 44684,53 & 1491,77 \\
          % & globi $\sim$ taxa + depth &  &  &  &  \\
          % & globi $\sim$ taxa * depth &  &  &  &  \\
          \hline
        \end{tabular} 
      \end{center}
