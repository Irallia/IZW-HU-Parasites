...
\newpage
    ...
    \subsection{Cross evaluation - leave 100 out}
      We ran the castor algorithm (\todo{10000}) 70 times with leaving 100 randomized free-living or 
      ...
      \begin{table}
        \begin{center}
          \begin{tabular}{ |cl||r|r|r|r| }
            ...
            \hline \hline
            \multirow{3}{*}{distance} & all   & 0 & 3587.70 & 199.68 & 253570.50 \\
            & leaf nodes                      & 0 & 3021.12 & 185.59 & 194202.16 \\
            & internal nodes                  & 0 & 566.58 & 14.08 & 5207.58 \\ \hline
            \multicolumn{2}{|c||}{changed tag} & 0 & 0 & 0 & 0 \\ \hline
            \multirow{3}{*}{lost} & all tags  & 100 & 100 & 100 & 0 \\
            & FL tags                         & 44 & 66 & 57.24 & 20.08 \\
            & P tags                          & 34 & 56 & 42.76 & 20.08 \\
            \hline
          \end{tabular}
        \end{center}
