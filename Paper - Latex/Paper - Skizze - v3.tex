    ...
    \section{Ancestral state reconstruction methods}
      ...
      \subsection{Fitch maximum parsimony}
        ...
        These four versions were tested in the simulation with 100 trees and 10000 leaf nodes and a
          ...
          node percentage. \\
        At 90~\% unknown nodes, version 1 was 89.67~\%, version 2 was 89.67~\%, version 3 was 90.72~\%, 
          and version 4 was 90.74~\% correct. Therefore, only version 4 was used for all further 
          simulations.
