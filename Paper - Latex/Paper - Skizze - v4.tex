      ...
      \begin{table}
        \begin{center}
          \hspace*{-0.5cm}\begin{tabular}{|>{\scriptsize}c|>{\scriptsize}l|>{\scriptsize}r|>{\scriptsize}r||>{\scriptsize}r|>{\scriptsize}r||>{\scriptsize}r|>{\scriptsize}r|>{\scriptsize}r||>{\scriptsize}r|>{\scriptsize}r|>{\scriptsize}r| }
            \hline
            & \bfseries Taxa & \bfseries \#internal & \bfseries \#leaf 
            ...
            & \bfseries subtree & \multicolumn{2}{>{\scriptsize}c||}{\bfseries nodes} & \bfseries FL & \bfseries P
            ...
            & \bfseries & & & & 
                ...
                & state & \bfseries FL $\rightarrow$ P & \bfseries P $\rightarrow$ FL \\
            \hline \hline
            ...
            & Chloro- & 43486 & 416478          & 3519 & 77         & 410795 & 4182 & 1501        & 0.5 & 97 & 222 \\
            & plastida & &                      & 97.86\% & 2.14\%  & 98.63\% & 1.00\% & 0.36\%   & & & \\ \cline{2-12}
...
\todo{-----}
    ...
    \subsection{Simulation of a phylogeny} \label{sec:discussion - simulate phylogeny}
      ...
      \todotext{It should be noted that we have optimized the distributions to the proportions and thus the number of state changes will be relatively high. With a smaller number of state changes, the predictive power of both algorithms would be even better.}
