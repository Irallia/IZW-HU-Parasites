...
\chapter{Introduction}
  ...
  \todo{Or:} The aim of this thesis is the application of maximum parsiomony algorithms to non-binary 
  ...
  \todotext{In den Bacteria und Archaea wurde das mal allgemein für binary traits gemacht: \\
  ...
  To accomplish this task, a large phylogenetic tree and information about the current species states 
    is needed. %In this work we use the synthesis tree of Open Tree of Life (OTL) \cite{Hinchliff2015} 
  ...
  \section{Results of the real data analysis created with Sankoff}
    ...
    \subsection{Biological view}
      ...
      In contrast to the other phyla examined, the phylogeny is more pronounced (less multifurcation) (see 
        ...
        \todo{A few punctual tests give us the following:}
      ...
      % \begin{itemize}
      %   \item Order Cypriniformes (7): carp-type without family.
      ...
      %     species in here.
      % \end{itemize}
      % For the Chordata as parasitic species were predicted in the following orders and families:
      % \begin{itemize}
      %   \item Order Cypriniformes (16), nine predicted parasites.
      %   \item Order Sauria (6), only given input parasites.
      %   \item Order Acanthomorphata(3), only given input parasites.
      %   \item Order Anura (1), only given input parasite.
      %   \item Order Siluriformes (1), only given input parasites.
      % \end{itemize}
      ...
      For the Platyhelminthes the literature says that there are mostly all Platyhelminthes parasites
        \todo{ref einfügen}. But at the end we predicted 0.1~\% as free-living. The class Seriata is the 
      ...
      \todo{The evolution of parasitism in Nematoda:} \\
