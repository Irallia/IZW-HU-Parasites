...
    For the Tree Open Tree of Life (OTL) is used \cite{Hinchliff2015} and for the state information 
  ...
  \section{Metadata analysis}
    ...
    \subsection{Transition probabilities}
      ...
      \begin{wrapfigure}{r}{0.5\textwidth}
        \begin{center}
          \includegraphics[trim = 0mm 0mm 0mm 0mm, clip, width=0.45\textwidth]{Figures/40-60.JPG}
        \end{center}
  ...
  \section{Simulation}\label{sec:simulation}
    ...
    The root node is defined as ancestor of all subsequent species and in this case, determined to be
      ...
      the randomly drawn number is above the threshold and the new node changes state. 
      \anmerkungstext{Für den Tree/Graph Traversal würde sich eine erklärende Abbildung anbieten. Nur 
      Text macht es sehr schwer verständlich an der Stelle. (Thilo)} \\
