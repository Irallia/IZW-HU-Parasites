  ...
  \section{Metadata analysis}
    ...
    \subsection{Transition probabilities}
      ...
      Different parasite types have different transition probabilities. It is very difficult to make a 
        ...
        is usually less likely. \todo{This is discussed in section x of the discussion.} \\
...
% simulate loss of information
  ...
  \section{real data analysis}
    ...
    We then evaluated the results in two ways. On the one hand, we have examined the results of some 
      ...
      hand, we performed a leaf 100 out cross validation.
...
\chapter{Results}
  ...
  We then evaluated the results in two ways. On the one hand, we have examined the results of some 
    ...
    \ref{sec:biological view}). On the other hand, we performed a leaf 100 out cross validation
    (Subsection \ref{sec:results cross evaluation}).

  % The next sections now guide you through the results of these different steps.
...
%    
  ...
  \section{Metadata analysis - Missing information} \label{sec:results - missing information}
    ...
    \subsection{Poisson regression of the multifurcation}
      ...
      The model multifurc $\sim$ order * mean.height turns out to be the best of our models, whereby it 
        is possible that eg multifurc $\sim$ family * mean.height is better.
  ...
  \section{Results of simulation / Influence of different parameters} \label{sec:results of simulation}
    ...
    \end{figure}
    First, we tested different trasition probability distributions including threshold (first column). 
  ...
  \section{Results of the real data analysis created with Sankoff}
    ...
    It is divided into two subsections. \ref{sec:biological view}: The analysis of some subtrees using 
      biological background knowledge. \ref{sec:results cross evaluation}: Presentation of the results 
      of the leaf 100 out cross validation.

    %---------------------------------------------------------------------------------------------------
    %---------------------------------------------------------------------------------------------------
    \subsection{Biological view} \label{sec:biological view}
    ...
    %---------------------------------------------------------------------------------------------------
    %---------------------------------------------------------------------------------------------------
    \subsection{Cross evaluation - leave 100 out} \label{sec:results cross evaluation}
      ...
      \begin{table}[h]
        \begin{center}
          \begin{tabular}{ |l|r|r|r| }
            ...
            \hline \hline
            correct predicted $\sim$ taxa & 117877 & \cellcolor{green!30}111466 & \cellcolor{green!45}108878 \\% & XXXXX \\
            \hline
            correct predicted $\sim$ taxa + depth & 117703 & \cellcolor{green!35}110513 & \cellcolor{green!45}108403 \\% & XXXXX \\
            \hline
            correct predicted $\sim$ taxa * depth & 117592 & \cellcolor{green!40}109827 & \cellcolor{green!50}107994 \\% & XXXXX \\
            \hline
          \end{tabular} 
        \end{center}
      ...
      \begin{table}[h]
        \begin{center}
          \begin{tabular}{ |l|r|r|r| }
            ...
            \bfseries Model / Taxa & \bfseries Kingdom & \bfseries Phylum & \bfseries Class \\% & Order \\
            \hline \hline
            correct predicted $\sim$ taxa & 117936 & \cellcolor{green!40}112242 & \cellcolor{green!50}111733 \\% & XXXXX \\
            \hline
            correct predicted $\sim$ taxa + depth & 117776 & \cellcolor{green!50}111304 & \cellcolor{green!50}111273 \\% & XXXXX \\
            \hline
            correct predicted $\sim$ taxa * depth & 117709 & \cellcolor{green!50}111262 & \cellcolor{green!30}113135 \\% & XXXXX \\
            \hline
          \end{tabular} 
        \end{center}
      ...
      Lower taxa than classes (eg order) were computationally too expensive to calculate. \\
      ...
      \begin{table}
        \begin{center}
          \begin{tabular}{ |cl||r|r|r|r| }
            \hline
            & & \bfseries min & \bfseries max & \bfseries mean & \bfseries variance \\
            \hline \hline
...
\chapter{Appendices}
  ...
  %---------------------------------------------------------------------------------------------------
  %---------------------------------------------------------------------------------------------------
  \section{Missing internal node modelling - Resiudal table} %\label{sec:Residuals unknown information}
    \begin{table}[h!]
      \begin{center}
          \begin{tabular}{ |l|r|r|r|r| }
            \hline
