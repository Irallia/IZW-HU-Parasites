...
\chapter{Introduction}
  ...
  To accomplish this task, next to the phylogenetic tree information about the current species' 
    states is needed. \\
  For this information we use the interaction database Global Biotic Interactions (GloBI) 
    \cite{Poelen2014}. The data in GloBI are stored as interactions e.g.  species A parasitize 
    species B. From this we conclude that species A is parasitic and species B free-living. \\
...
    For the tree Open Tree of Life (OTL) is used \cite{Hinchliff2015} and for the state information 
    ...
    \subsection{OTL}
      ...
      % For taxonomic data, there are at least five big data collections, namely:
      % \begin{itemize}
