...
\todo{old:}
  ...
  We evaluated these on the one hand by analysing some statisitcs (subsection 
...
\chapter{Discussion}
  ...
  \section{Data situation} \label{sec:discussion - data situation}
    ...
    Furthermore, we know that OTL is a synthesis of 819 phylogenetic trees. This suggests that just 
      ...
      taxonomy. \\
    \todotext{
    For a review of this underlying taxonomy, we have compiled a list of all taxa and drawn them in 
      relation to their distribution (see appendix section \ref{sec:otl analysis}).
    The number of nodes in the tree corresponding to a taxonomic rank is tabulated. \\
    For the classical taxonomic ranks phylum, class, order, family, genus xyz is found (appendix 
      \ref{sec:otl analysis}). \\
    A closer look is taken at some of the features of the synthesis tree on the one hand the 
      distribution of the taxa and on the other the distribution of the nodes on the taxa. Since 
      this is \colorbox{red}{not directly relevant} for this study, this section has been moved to 
      the appendix \ref{sec:otl analysis}.}
...
\newpage
  ...
  %---------------------------------------------------------------------------------------------------
  \subsection{Distribution of data in the taxa}
    ...
    \begin{table}[h!]
      \begin{center}
        \begin{tabular}{ |l|r|l|r|r| }
          ...
          & & Hemichordata & 196 & 5 \\ 
          & & Cycliophora & 11 & 5 \\ 
          % 1465207-(1170539+106650+80022+27141+24564+14878+11737+10654+8631+3093+1793+1654+1596+1055+633+360+196+11) = 0
          \hline
