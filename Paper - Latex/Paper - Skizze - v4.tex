...
% simulate loss of information
  ...
  \section{real data analysis}
    ...
    We then evaluated the results in two ways. On the one hand, we have examined the results of some 
      sub-trees for their credibility with the help of biological background knowledge. On the other 
...
\chapter{Results}
  ...
  We then evaluated the results in two ways. On the one hand, we have examined the results of some 
    sub-trees for their credibility with the help of biological background knowledge (Subsection 
